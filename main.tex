...
\midrule
Tokenization & We use the default T5TokenizerFast from HuggingFace (\texttt{google-t5/t5-small}). Encoder input format: ``translate English to SQL: [natural language question]''. Decoder receives teacher-forced SQL tokens during training. Maximum sequence lengths: 512 tokens for both encoder and decoder. \\
\midrule
